...
def render_execution():
    ...
    st.info("Click the button below to start the pipeline. You can monitor progress in real-time.")
    
    if st.button("🚀 Start Pipeline Execution", type="primary", use_container_width=True):
