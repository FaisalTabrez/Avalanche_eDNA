...
try:
    ...
    # Triton not available (CPU-only system) - use standard attention
    flash_attn_qkvpacked_func = None
    print("Warning: Flash Attention (triton) not available, using standard attention")
try:
    pass  # Keep original try block
