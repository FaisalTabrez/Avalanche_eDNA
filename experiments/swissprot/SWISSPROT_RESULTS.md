# SwissProt Pipeline Simulation Results (ARCHIVED)

> DEPRECATED: SwissProt experiments are archived. This project is eDNA-focused; SwissProt/protein experiments are kept for historical reference and are not maintained.



# SwissProt Pipeline Simulation Results

## Overview
Successfully ran the complete production pipeline with dynamic scaling on SwissProt protein database.
