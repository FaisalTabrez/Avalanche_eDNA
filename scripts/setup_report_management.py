...
def main():
    ...
    try:
        ...
        logger.info(
            "1. Launch dashboard: python -m streamlit run src/dashboards/report_management_dashboard.py"
        )
        logger.info(
            "2. Start API server: python -m uvicorn src.api.report_management_api:app --reload"
        )
