...
# Title
fig.suptitle(
    "eDNA Taxonomy Classification Pipeline - Complete Revision",
    fontsize=18,
    fontweight="bold",
    y=0.98,
)
...
bars = ax3.bar(
    strategies, accuracies, color=colors, alpha=0.7, edgecolor="black", linewidth=2
)
...
y_new = 2.0
ax4.text(
    0.5, y_new + 0.5, "NEW PIPELINE", fontsize=10, fontweight="bold", color="green"
)
...
highlight = Rectangle(
    (6.5, 1.5), 2, 1.5, linewidth=3, edgecolor="green", facecolor="none", linestyle="--"
)
...
table = ax5.table(
    cellText=config_data, cellLoc="center", loc="center", colWidths=[0.4, 0.3, 0.3]
)
