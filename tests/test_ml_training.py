...
class TestDNAContrastiveModel:
    ...
    def test_contrastive_model_creation(self):
        ...
        backbone = DNATransformerEmbedder(
            vocab_size=vocab_size, d_model=128, num_layers=2
        )

        contrastive_model = DNAContrastiveModel(
            backbone_model=backbone, projection_dim=64, temperature=0.1
        )
    ...
    def test_contrastive_forward_pass(self):
        ...
        contrastive_model = DNAContrastiveModel(
            backbone_model=backbone, projection_dim=64
        )
...
class TestEmbeddingTrainer:
    ...
    def test_train_autoencoder_single_epoch(self):
        ...
        pytest.skip(
            "Autoencoder training requires proper sequence reconstruction implementation"
        )
    ...
    def test_train_contrastive_single_epoch(self):
        ...
        backbone = DNATransformerEmbedder(
            vocab_size=vocab_size, d_model=64, num_layers=2
        )
    ...
    def test_save_and_load_model(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Load model
            new_model = DNATransformerEmbedder(
                vocab_size=vocab_size, d_model=64, num_layers=2
            )
...
class TestModelFactory:
    ...
    def test_create_transformer(self):
        ...
        config = {"d_model": 128, "nhead": 4, "num_layers": 3, "dropout": 0.1}
    ...
    def test_create_autoencoder(self):
        ...
        config = {"embedding_dim": 32, "latent_dim": 16, "hidden_dims": [64, 128, 64]}
    ...
    def test_create_contrastive(self):
        ...
        config = {"projection_dim": 64, "temperature": 0.07}
