...
from clustering.lineage_visualization import LineageExporter, TaxonomicTreeVisualizer
from clustering.multi_source_taxonomy import (
    CustomTaxonomySource,
...
class TestEnhancedLineage:
    ...
    def test_external_reference(self):
        ...
        ref_custom = ExternalReference(
            database="Custom", identifier="123", url="https://example.com/taxon/123"
        )
    ...
    def test_enhanced_lineage(self):
        ...
        lineage = EnhancedLineage(taxid=9606, scientific_name="Homo sapiens")
        ...
        evidence = LineageEvidence(source=EvidenceType.NCBI_TAXDUMP, confidence=0.9)
...
class TestLineageExporter:
    ...
    def test_json_export(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            # Create test lineage
            lineage = EnhancedLineage(taxid=12345, scientific_name="Test organism")
...
class TestEnhancedTaxonomySystem:
    ...
    def test_system_initialization(self):
        ...
        config_dict = {
            ...
            "enhanced_lineage": {"enable_caching": False},
            "multi_source": {"enabled": False},
            "auto_update": {"enabled": False},
        }

        system = EnhancedTaxonomySystem(
            config_dict=config_dict, enable_enhanced_features=True
        )
...
def sample_lineage():
    ...
    # Add evidence
    evidence = LineageEvidence(
        source=EvidenceType.NCBI_TAXDUMP, confidence=1.0, method_details="Test data"
    )
    lineage.add_evidence(evidence)
